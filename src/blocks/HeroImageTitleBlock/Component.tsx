    ...
    <section className="relative w-full h-[100vh] overflow-hidden ">
      ...
      <div className="relative h-[90%]">
        <div className="container h-full flex flex-col items-center justify-end pb-10 md:pb-14 lg:pb-16 gap-4 text-center">
          <h1 className="text-white font-semibold leading-tight text-4xl md:text-6xl lg:text-7xl max-w-5xl w-full">
            <TextReveal as="span" text={title ?? ''} />
          </h1>

          <p className="text-white leading-tight text-xl md:text-4xl lg:text-xl max-w-5xl w-full">
